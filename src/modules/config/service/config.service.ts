...
import { InquiryAddressOptionsFormDbFuncType, InquiryBankOptionsFormDbFuncType, InquiryBrandOptionsFormDbFuncType, InquiryPlatformCategoryOptionsFormDbFuncType, OptionType } from '../type/config.type'
